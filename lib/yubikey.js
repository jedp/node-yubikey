...
Yubikey.prototype = {
  verify: function yubikey_verify(otp, callback, cbp) {
    this._genNonceAsync(function(err, nonce) {
      ...
      this._request(params, callback, cbp);
    }.bind(this));
  },

  _request: function yubikey__request(params, callback, cbp) {
    ...
    request(uri, function(err, res, body) {
     if (res != null) {
      ...
      this._validateResponse(responseParams, params, callback, cbp); }
     else { return callback(new Error("Cannot connect to yubico servers")); }
    }.bind(this));
  },

  _validateResponse: function yubikey__validateResponse(response, request, callback, cbp) {
